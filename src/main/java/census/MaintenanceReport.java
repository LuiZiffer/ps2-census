...
public class MaintenanceReport {
    ...
    protected MaintenanceReport(List<World> worldStatusList, List<GameServerStatus> serverStatusList, boolean gameMaintenanceFlag, boolean launcherMaintenanceFlag) {
    ...
    public static MaintenanceReport createReport(String serviceId) throws CensusException, IOException {
        return new MaintenanceReport(getWorldStatus(serviceId), getGameServerStatus(serviceId),
                getGameMaintenanceFlag(), getLauncherMaintenanceFlag());
    }
