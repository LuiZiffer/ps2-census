...
public class PlayerFacilityCapture extends EventPayloadObject {
	...
	public String toString() {
		return "PlayerFacilityCapture [character_id=" + character_id + ", facility_id=" + facility_id + ", outfit_id="
